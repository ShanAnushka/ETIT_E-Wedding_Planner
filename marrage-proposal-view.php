...
<head>
    ...
    <df-messenger intent="WELCOME" chat-title="Silver_Star" agent-id="bda67fa0-4fb6-46b7-a164-03cb10ab482a" language-code="en"></df-messenger>
</head>
...
<body>
    ...
    <!--importance-->
    <center>
        <div class="content" style="background-color: #3c3645;">
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 ftr_icon1"><img src="images/sem_icon1.png" />
                        <p style="color: white;">Best Matches</p>
                    </div>
                    <div class="col-sm-4 ftr_icon2"><img src="images/sem_icon2.png" />
                        <p style="color: white;">Fastest Response</p>
                    </div>
                    <div class="col-sm-4 ftr_icon3"><img src="images/sem_icon3.png" />
                        <p style="color: white;">Safe & Secure</p>
                    </div>
                </div>
            </div>
        </div>
